...
{
    public class ProductServiceMoq : Mock<IProductService>
    {
        ...
        public ProductServiceMoq MockGetAll()
        {
            Setup(i => i.GetAll()).Returns(Items);
            return this;
        }

        public ProductServiceMoq MockGetCategory(int catId)
        {
        ...
        public ProductServiceMoq MockGetFeatured()
        {
            //bit of a hack, but we don't have a direct link to categories in the Product, which we really should.
